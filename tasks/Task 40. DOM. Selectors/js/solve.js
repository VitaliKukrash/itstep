...
let element1 = document.getElementById("fifth-element");

console.log(element1);

let divs1 = element1.parentElement.parentElement.classList.toggle("fifth-element");



for (let i = 1; i <= 5; i++){
    let divs2 = document.createElement("div");
    divs2.innerHTML = "Я сосед";
    element1.appendChild(divs2);
}
